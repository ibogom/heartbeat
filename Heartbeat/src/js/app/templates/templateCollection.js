...
Handlebars.registerPartial("GetBeats.hbs", this["Heartbeat"]["GetBeats.hbs"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "        <div class=\"beats-cat-title-wrapper\">\r\n            <span class=\"title\">Choose your favorite music categories :</span>\r\n            <span class=\"done btn-scnd-bg\">Done</span>\r\n        </div>\r\n        <ul class=\"beats-cat-wrapper\">\r\n"
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.genre_id : depth0),{"name":"each","hash":{},"fn":this.program(4, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "        </ul>\r\n";
  ...
  return "<div>\r\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showGetBeats : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showBeatsCategorys : depth0),{"name":"if","hash":{},"fn":this.program(3, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "</div>";
},"useData":true}));
...
Handlebars.registerPartial("HeaderView.hbs", this["Heartbeat"]["HeaderView.hbs"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "            <ul class=\"list-switch\">\r\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showHomeNav : depth0),{"name":"if","hash":{},"fn":this.program(10, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "            </ul>\r\n";
  ...
  return "<div>\r\n    <div class=\"left-el icons\">\r\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showSettings : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showMenu : depth0),{"name":"if","hash":{},"fn":this.program(3, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showLeftBack : depth0),{"name":"if","hash":{},"fn":this.program(5, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "    </div>\r\n    <div class=\"middle-el\">\r\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showTitle : depth0),{"name":"if","hash":{},"fn":this.program(7, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showlist : depth0),{"name":"if","hash":{},"fn":this.program(9, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showSend : depth0),{"name":"if","hash":{},"fn":this.program(12, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "    </div>\r\n    <div class=\"right-el icons\">\r\n"
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showRightBack : depth0),{"name":"if","hash":{},"fn":this.program(14, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showMessages : depth0),{"name":"if","hash":{},"fn":this.program(16, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.showSearch : depth0),{"name":"if","hash":{},"fn":this.program(18, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "    </div>\r\n</div>";
},"useData":true}));
...
Handlebars.registerPartial("PlayerView.hbs", this["Heartbeat"]["PlayerView.hbs"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"volume-bar\">\r\n    <span class=\"volume-low icons\"></span>\r\n        <span class=\"volume-wrapper\">\r\n            <span class=\"volume-trigger\" style=\"width:"
    ...
    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.isPlayed : depth0),{"name":"if","hash":{},"fn":this.program(1, data, 0),"inverse":this.program(3, data, 0),"data":data})) != null ? stack1 : "")
    ...
    + alias3(((helper = (helper = helpers.minutes || (depth0 != null ? depth0.minutes : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"minutes","hash":{},"data":data}) : helper)))
    + ":"
    + alias3(((helper = (helper = helpers.seconds || (depth0 != null ? depth0.seconds : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"seconds","hash":{},"data":data}) : helper)))
...
Handlebars.registerPartial("PlaylistView.hbs", this["Heartbeat"]["PlaylistView.hbs"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\""
    ...
    + alias3(((helper = (helper = helpers.media_id || (depth0 != null ? depth0.media_id : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"media_id","hash":{},"data":data}) : helper)))
...
Handlebars.registerPartial("ProfileView.hbs", this["Heartbeat"]["ProfileView.hbs"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"photo\">\r\n    <img src=\""
    ...
    + alias3(((helper = (helper = helpers.songsNumber || (depth0 != null ? depth0.songsNumber : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"songsNumber","hash":{},"data":data}) : helper)))
    + "</span>\r\n            <span class=\"listeners-res\">"
    + alias3(((helper = (helper = helpers.listenersNumber || (depth0 != null ? depth0.listenersNumber : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"listenersNumber","hash":{},"data":data}) : helper)))
    ...
    + alias3(((helper = (helper = helpers.beatsNow || (depth0 != null ? depth0.beatsNow : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"beatsNow","hash":{},"data":data}) : helper)))
    + "</span> / "
    + alias3(((helper = (helper = helpers.maxBeats || (depth0 != null ? depth0.maxBeats : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"maxBeats","hash":{},"data":data}) : helper)))
    + "</span>\r\n</div>";
},"useData":true}));
