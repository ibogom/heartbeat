module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        clean: {
            short: ["www/js", "www/assets"]
        },
        copy: {
            main: {
                files: [
                    {expand: true, cwd: 'src/assets/imgs', src: ['**'], dest: 'www/assets/imgs'},
        ...
        requirejs: {
            compile: {
                options: {
                    ...
                    out: "www/js/main.min.js" // выходящий минифицированный и конкатенированный файл готовые для продакшена
                }
            }
        },
        ...
        sass: {
            dist: {
                ...
                files: {
                    ...
                    'www/assets/css/main_black.css': ['src/assets/sass/main_black.scss']
